...
<div class="container mt-3">
    <div class="row">
        <div class="col">
            <h3 class="mb-0">Coordenadoria de Proteção de Recursos Naturais e Educação Ambiental</h3>
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="<?php echo BASE_URL ?>">Página Inicial</a></li>
                    <li class="breadcrumb-item active">Coordenadoria de Proteção de Recursos Naturais e Educação Ambiental</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <p class="mb-0"><b>À Coordenadoria de Proteção de Recursos Naturais e Educação Ambiental</b>, compete:</p>
