<div class="container-fluid mt-3">
    <div class="row">
        <div class="col">
            <h4 class="mb-1 ms-2"> Termos de Refêrencias</h4>
            <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                <ol class="breadcrumb p-2 rounded">
                    ...
                    <li class="breadcrumb-item active" aria-current="page"><i class="fa-solid fa-file-pdf me-1"></i> Termos de Refêrencias</li>
                </ol>
            </nav>
        </div>
    </div>
            ...
            <section class="card">
                ...
                <div class="collapse" id="collapseExample">
                    <article class="card-body">
                        <form method="GET" name="formTRSearch" action="<?php echo BASE_URL ?>tr/1">
                            <div class="row">
        ...
        <div class="row">
            <div class="col">
                <nav aria-label="Page navigation example">
                    <ul class="pagination">
                        <?php
                        echo "<li class='page-item'><a class='page-link' href='" . BASE_URL . "tr/1" . $parametros . "'><span aria-hidden='true'>&laquo;</span></a></li>";
                        $pg = ceil($paginas);
                        $limite = 3;
                        ...
                        if ($pg > $pgprev && $pgprev >= $limite) {
                            echo "<li class='page-item'><a class='page-link' href='" . BASE_URL . "tr/1" . $parametros . "'><span aria-hidden='true'>1</span></a></li>";
                            if ($pgprev >= $limite) {
                        ...
                        for ($p = 0; $p < $pg; $p++) {
                            if ($pagina_atual == ($p + 1)) {
                                echo "<li class='page-item active'><a class='page-link' href='" . BASE_URL . "tr/" . ($p + 1) . $parametros . "'>" . ($p + 1) . "</a></li>";
                            } else {
                                if ($pgprev <= ($p + 1) && ($p + 1) < $pagina_atual) {
                                    echo "<li class='page-item'><a class='page-link' href='" . BASE_URL . "tr/" . ($p + 1) . $parametros . "'>" . ($p + 1) . "</a></li>";
                                }
                        ...
                        if ($pg > $pgnext && $pgnext >= $limite) {
                            ...
                            echo "<li class='page-item'><a class='page-link' href='" . BASE_URL . "tr/" . ceil($paginas) . $parametros . "'><span aria-hidden='true'>" . ceil($paginas) . "</span></a></li>";
                        }
                        echo "<li class='page-item'><a class='page-link' href='" . BASE_URL . "tr/" . ceil($paginas) . $parametros . "'>&raquo;</a></li>";
                        ?>
                    </ul>
                </nav>
            </div>
            ...
            <article class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <section class="modal-content">
                    ...
                    <footer class="modal-footer">
                        <a class="btn btn-outline-danger pull-left" href="<?php echo BASE_URL . 'tr/excluir/' . md5($indice['id']) ?>"> <i class="fa fa-trash"></i> Excluir</a>
            ...
            <article class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <section class="modal-content">
                    <header class="modal-header bg-primary">
                        <h5 class="modal-title text-white"><i class="fa-solid fa-file-pdf me-1"></i> Termos de Refêrencias</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </header>
                    <article class="modal-body p-1">
                        <table class="table align-middle m-0">
